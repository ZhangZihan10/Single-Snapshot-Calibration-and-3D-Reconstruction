...
% detect region of black pixels   Image=imread('testr26_2.jpg');
...
White = Image(:,:,1)>=230 & Image(:,:,2)>=230 & Image(:,:,3)>=230;   %imshow(White)
...
BWEdge=ismember(labelmatrix(bwconncomp(BWEdge,8)), find([stats.Area] > 150));
