%%成功 稳定  虚拟环境与真实环境   加坐标轴

function [C_B, R_CW, T_BC, dbg] = pose_from_board_no_rotation7_1(calib_data, kk, squareSize, use_corner_find,opts)
...
%[Xg, Yg] = meshgrid(0:n_sq_y, 0:n_sq_x);
