%%原始方法，两个校准板
%图像增强
%img=imread('testr32_0.jpg'); up_scale=3;im_h = SRCNN_single_image(img, up_scale);enhanced_name = 'testr32_01.jpg';imwrite(im_h, enhanced_name);

%function [c_x,c_y,c_z,l_x,l_y,z_las_dist,Y1,Y2,ocam_model] = calib_process
clear

%cam=webcam(2);cam.Resolution='1920x1080';
%image =snapshot(cam);imwrite(image,'testr32_0.jpg');
...
i = calib_data.n_ima;
calib_data.L(i+1)={'testr31_02.jpg'};
%calib_data.L(i+1)={'testr32_01.jpg'};
use_corner_find=1;
...
calib_data.L(i+2)={'testr31_01.jpg'};
use_corner_find=1;
...
I1 = imread('testr31_03.jpg');I2 = imread('testr31_02.jpg');
I = las_segm(I1,60); I0 = las_segm(I2,60); I = I| I0; %imshow(I);    % 如果是逻辑/二值图像
%I = LaserFind4(I1);
...
%% test fo paper
%camX=-4; camY =-3; camZ =3; l_x =3; l_y =2; z_las_dist=-213;
%load('Omni_Calib_Results_Sim.mat');

% fitting laser points for each side of the target
%img1 = las_segm(I1_,60);
%img1 = bwmorph(img1,'skel',Inf);
%img1=LaserFind4(I1_);%imshow(img1);
I3=imread('testr31z2.jpg');%imshow(I3);
I3 = LaserFind4(I3);
[x,y] = mapping(I3,camX,camY,camZ,...
    -l_y,-l_x,-z_las_dist,ocam_model);
%[x1,y1] = mapping_points(Cent1,camX,camY,camZ,...
%    -l_y,-l_x,-z_las_dist,ocam_model);
