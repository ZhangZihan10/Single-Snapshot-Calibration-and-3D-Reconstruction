...
%% 图像增强处理后 Matlab自带
%图像增强
%img=imread('0001.jpg'); up_scale=3; im_h = SRCNN_single_image(img, up_scale);enhanced_name = '000_1.jpg';imwrite(im_h, enhanced_name);
