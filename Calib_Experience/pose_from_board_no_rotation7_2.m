%%成功 使用角度误差法  虚拟环境与真实环境   加坐标轴

function [C_B, R_CW, T_BC, dbg,roll_deg, pitch_deg, yaw_deg] = pose_from_board_no_rotation7_2(calib_data, kk, squareSize, use_corner_find,opts)
...
[Xg, Yg] = meshgrid(0:n_sq_x, 0:n_sq_y);   % ✅ 交换定义
WP = [Xg(:)*squareSize, Yg(:)*squareSize, zeros(numel(Xg),1)];  % ✅ 同时交换坐标位置
