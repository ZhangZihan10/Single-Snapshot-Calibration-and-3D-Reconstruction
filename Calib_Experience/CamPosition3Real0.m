...
%图像增强
%img=imread('test08.jpg'); % read image
%up_scale=3;
%im_h = SRCNN_single_image(img, up_scale);
% 保存增强结果
%enhanced_name = 'test08E.jpg';
...
[C_B, R_WC, T_BC, dbg, roll_deg, pitch_deg, yaw_deg] = pose_from_board_no_rotation7_3(calib_data, i+1, squareSize, true, opts);
