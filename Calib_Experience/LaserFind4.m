...
function img=LaserFind4(image)

%imwrite(image,'1.jpg');%black_image = imread('testr32z2.jpg');
...
minPixelCount = 200;   % 保留的最小尺寸
maxPixelCount = 4000; % 保留的最大尺寸
...
% 设置要保留的最小和最大像素数量（根据需要调整）
minPixelCount2 = 1000;   % 保留的最小尺寸
maxPixelCount2 = 2000; % 保留的最大尺寸
...
% 设置要保留的最小和最大像素数量（根据需要调整）
minPixelCount4 = 1000;   % 保留的最小尺寸
maxPixelCount4 = 1500; % 保留的最大尺寸
...
% 设置要保留的最小和最大像素数量（根据需要调整）
minPixelCount6 = 1000;   % 保留的最小尺寸
maxPixelCount6 = 1200; % 保留的最大尺寸
