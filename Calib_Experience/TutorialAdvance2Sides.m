...
%% Border extraction
I1_ = imread('TestImages/image9_2.jpg'); % read image  figure;imshow(I1_)
...
%% test fo paper
%cam_pitch_opt=-3; cam_roll_opt =-3; cam_yaw_opt =3; las_pitch_opt =-2; las_roll_opt =-4; las_dist_opt=450;
...
%% 创建输出图像（拷贝原图）
I_overlay = imread('C:\论文\全向视觉畸变校准\图片\校准实验虚拟/image9_2.jpg');
