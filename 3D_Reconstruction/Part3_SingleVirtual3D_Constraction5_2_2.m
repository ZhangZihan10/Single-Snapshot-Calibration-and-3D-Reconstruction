...
camX2 = -2.312; camY2 = 1.378; camZ2 = 4.193;
CVsyst_rot = 0;
las_dist = 320.99;
%CVsyst_x = 1800;
%CVsyst_y = 3400;
...
% 获取图像列表
outputFolder = 'obstacle_boardsR1';
...
outputFolder2 = 'obstacle_boardsR1L';%激光识别文件
...
for i = 1:length(imageFiles)
    ...
    figure;scatter(x1,y1,5,'filled',"green");
